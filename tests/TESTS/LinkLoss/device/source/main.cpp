...
class LinkLossServiceDemo : ble::Gap::EventHandler, LinkLossService::EventHandler {
public:
    LinkLossServiceDemo(BLE &ble, events::EventQueue &event_queue, ChainableGapEventHandler &chainable_gap_event_handler) :
            _ble(ble),
    ...
    void start()
    {
        _ble.init(this, &LinkLossServiceDemo::on_init_complete);
...
int main()
{
    ...
    LinkLossServiceDemo demo(ble, event_queue, chainable_gap_event_handler);
    demo.start();
